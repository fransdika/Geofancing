            ...
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown hover-dropdown">
                        <a class="nav-link dropdown-toggle drop-arrow-none" href="{{ route('root') }}">
                    ...
                    <li class="nav-item dropdown hover-dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            ...
                            <a href="{{ route ('second' , ['pages','pricing']) }}" class="dropdown-item">Pricing One</a>
                    ...
                    <li class="nav-item dropdown hover-dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-layouts">
                            <a href="{{ route('root') }}" class="dropdown-item" target="_blank">Vertical</a>
                            <a href="{{ route ('second' , ['layout-demo','horizontal']) }}" class="dropdown-item" target="_blank">Horizontal</a>
                            <a href="{{ route ('second' , ['layout-demo','detached']) }}" class="dropdown-item" target="_blank">Detached</a>
                            <a href="{{ route ('second' , ['layout-demo','full']) }}" class="dropdown-item" target="_blank">Full</a>
                            <a href="{{ route ('second' , ['layout-demo','fullscreen']) }}" class="dropdown-item" target="_blank">Fullscreen</a>
                            <a href="{{ route ('second' , ['layout-demo','hover']) }}" class="dropdown-item" target="_blank">Hover Menu</a>
                            <a href="{{ route ('second' , ['layout-demo','compact']) }}" class="dropdown-item" target="_blank">Compact Menu</a>
                            <a href="{{ route ('second' , ['layout-demo','icon-view']) }}" class="dropdown-item" target="_blank">Icon View</a>
                        </div>
                    </li>
                </ul>
            </div>
